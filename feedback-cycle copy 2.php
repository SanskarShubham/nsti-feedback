...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['edit_cycle'])) {
        ...
        if (!empty($cycle_name) && !empty($start_date) && !empty($end_date) && !empty($cycle_id)) {
             if ($start_date >= $end_date) {
                $message = "Error: Start date must be before the end date.";
                $message_type = 'error';
            } else {
...
<head>
    ...
    <style>
        <?php
        // Embedding the provided CSS directly. For production, it's better to link to an external file.
        echo file_get_contents('https://cdn.jsdelivr.net/gh/karan-sahu/nsti-feedback-portal@main/css/style.css');
        ?>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Manage Feedback Cycles</h4>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <button class="btn btn-info btn-sm" onclick="openEditModal(
                                                                ...
                                                                '<?php echo $start->format('Y-m-d\TH:i'); ?>',
                                                                '<?php echo $end->format('Y-m-d\TH:i'); ?>'
                                                            )">Edit</button>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; ?>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="datetime-local" id="edit_start_date" name="edit_start_date" class="form-control" required>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="edit_end_date">End Date & Time</label>
                            <input type="datetime-local" id="edit_end_date" name="edit_end_date" class="form-control" required>
                        </div>
                    </div>
                </div>
