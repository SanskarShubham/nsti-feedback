...
<style>
    .table-scrollable {
        /* Define a max-height to make the container scrollable */
        max-height: 65vh; /* 65% of the viewport height, adjust as needed */
        overflow-y: auto;
    }
    .table-scrollable thead th {
        ...
        position: sticky;
        top: 0;
        z-index: 2; /* Keeps the header above the scrolling body */
        /* Set a background color, otherwise it will be transparent */
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form class="form-valide" action="" method="post" autocomplete="off">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select class="form-control" id="trade_id" name="trade_id" required>
                            ...
                            // This now correctly submits the trade NAME to match the query
                ...
                <!-- MODIFICATION: Added 'table-scrollable' class to the div -->
                <div class="table-responsive table-scrollable">
                    <table class="table table-striped table-bordered">
                        <!-- MODIFICATION: Corrected the thead structure -->
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Student Name</th>
