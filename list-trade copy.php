                ...
                <table class="table table-bordered table-striped verticle-middle">
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <td><span>
                                    &nbsp;&nbsp;
                                    <a href="<?php echo 'edit-trade.php?id=' . $row['trade_id']; ?>" class="m-r-10" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-pencil color-muted m-r-10 "></i> </a>&nbsp;&nbsp;
                                    <a onclick="return confirm('Are you sure?')" href="<?php echo 'backend/delete-trade.php?id=' . $row['trade_id']; ?>" class="" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-close color-danger"></i></a>
                                </span></td>
